...
(function () {
    ...
    var fullUrl = chrome.extension.getURL('js/preprocess.wrap.js');
    var preprocessorScript;
    $.get(fullUrl.toString(),function (data){
        preprocessorScript = data;
    });
    ...
    handlers.getPreprocessor = function(done){
        done(preprocessorScript);
    };
